            ...
            <div className="flex flex-col ">
                <div className="flex gap-4">
                    ...
                    <div>
                        ...
                        <div>
                            {deviceBorderRadius === "pc" && (<div className="flex">
                            ...
                            {deviceBorderRadius === "tablet" && (<div className="flex">
                                    <div className="relative">
                                        <input className="rounded-xl border w-full border-slate-200 py-2 px-4 text-xs" value={inputsJson.borderRadius
                .tablet[0]} onChange={(e) => handleDataInput(e)} type="number" name="borderRadius_top_tablet" id=""/>
                                        <span className="absolute right-0 bottom-0 bg-slate-300 p-2 rounded-xl text-xs">
                                            px
                                        </span>
                                    </div>
                                    <div className="relative">
                                        <input className="rounded-xl border w-full border-slate-200 py-2 px-4 text-xs" value={inputsJson.borderRadius
                .tablet[1]} onChange={(e) => handleDataInput(e)} type="number" name="borderRadius_right_tablet" id=""/>
                                        <span className="absolute right-0 bottom-0 bg-slate-300 p-2 rounded-xl text-xs">
                                            px
                                        </span>
                                    </div>
                                    <div className="relative">
                                        <input className="rounded-xl border w-full border-slate-200 py-2 px-4 text-xs" value={inputsJson.borderRadius
                .tablet[2]} onChange={(e) => handleDataInput(e)} type="number" name="borderRadius_bottom_tablet" id=""/>
                                        <span className="absolute right-0 bottom-0 bg-slate-300 p-2 rounded-xl text-xs">
                                            px
                                        </span>
                                    </div>
                                    <div className="relative">
                                        <input className="rounded-xl border w-full border-slate-200 py-2 px-4 text-xs" value={inputsJson.borderRadius
                .tablet[3]} onChange={(e) => handleDataInput(e)} type="number" name="borderRadius_left_tablet" id=""/>
                                        <span className="absolute right-0 bottom-0 bg-slate-300 p-2 rounded-xl text-xs">
                                            px
                                        </span>
                                    </div>
                                </div>)}
                            {deviceBorderRadius === "movil" && (<div className="flex">
                                    <div className="relative">
